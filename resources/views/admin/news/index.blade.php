...
<div class="row">
  <div class="col">
    ...
    <div class="card my-3">
      <div class="card-body">
        <form method="get" action="{{ route('adminNews') }}">
          @csrf
          <div class="form-row">
            <div class="col-md-5">
...
<div class="row">
  <div class="col">
    <div class="d-flex my-2 justify-content-end">
      <a href="{{ route('adminNews.create') }}" class="btn btn-success"><i class="fas fa-plus-square"></i> Agregar Nuevo</a>
      <a href="{{ route('adminNews.trashed') }}" class="btn btn-danger mx-2"><i class="fas fa-trash-restore"></i> Ver Papelera</a>
    </div>
  </div>
</div>
<div class="row">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('adminNews.edit', $new) }}"><i class="fas fa-edit"></i></a>
              <form method="post" action="{{ route('adminNews.trash', $new) }}" class="d-inline">
                {{ csrf_field() }}
                {{ method_field('patch') }}
