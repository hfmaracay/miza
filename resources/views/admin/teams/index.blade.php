...
<div class="row">
  <div class="col">
    ...
    <div class="card my-3">
      <div class="card-body">
        <form method="get" action="{{ route('adminTeams') }}">
          @csrf
          <div class="form-row">
            <div class="col-md-5">
...
<div class="row">
  <div class="col">
    <div class="d-flex my-2 justify-content-end">
      <a href="{{ route('adminTeams.create') }}" class="btn btn-success"><i class="fas fa-plus-square"></i> Agregar Nuevo</a>
      <a href="{{ route('adminTeams.trashed') }}" class="btn btn-danger mx-2"><i class="fas fa-trash-restore"></i> Ver Papelera</a>
    </div>
  </div>
</div>
<div class="row">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('adminTeams.edit', $team) }}"><i class="fas fa-edit"></i></a>
              <form method="post" action="{{ route('adminTeams.trash', $team) }}" class="d-inline">
                {{ csrf_field() }}
                {{ method_field('patch') }}
