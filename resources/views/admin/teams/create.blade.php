  ...
  <div class="col-md-8">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        @endif
        <form id="form-create" name="form-create" method="POST" action="{{ route('adminTeams.store') }}" enctype="multipart/form-data" class="form-class needs-validation" novalidate>
          @csrf
          <div class="form-group">
            <label for="name" class="sr-only">Nombre</label>
            <input type="text" name="name" id="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name') }}" placeholder="Nombre" required />
          ...
          <div class="form-group">
            ...
            <input type="text" name="last_name" id="last_name" class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" value="{{ old('last_name') }}" placeholder="Apellido" required />
            <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <input type="text" name="title" id="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title') }}" placeholder="Cargo" required />
            <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <textarea name="description" id="description" cols="30" rows="5" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" placeholder="Descripción" required>{{ old('description') }}</textarea>
            <div class="invalid-feedback">
