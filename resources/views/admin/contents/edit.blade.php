  ...
  <div class="col-md-10">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        @endif
        <form id="form-update" name="form-update" method="POST" action="{{ route('adminContents.update', $content) }}" enctype="multipart/form-data" class="form-class needs-validation" novalidate>
          @csrf
          {{ method_field('PUT') }}
          <div class="form-group">
            <label for="name" class="sr-only">Título</label>
            <input type="text" name="name" id="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"value="{{ old('name', $content->name) }}" placeholder="Título" required />
          ...
          <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control textareacontent {{ $errors->has('description') ? 'is-invalid' : '' }}" cols="30" rows="6" required>{!! $content->description !!}</textarea>
            <div class="invalid-feedback">
